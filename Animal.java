...
public class Animal extends Actor
{
    ...
    public void eat()
    {
        Food actor = (Food) getOneObjectAtOffset(0, 0, Food.class);
        if(actor != null) {
            energy += actor.getNutrition();
            DeadGrass temp = new DeadGrass();
            ((atfc_world)this.getWorld()).addObject(temp, actor.getX(),actor.getY());
