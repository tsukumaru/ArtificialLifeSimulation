...
public class Plotter extends Actor
{
    ...
    private static JLabel count3Label;
     ...
     */
    public Plotter(int width, int height, int startMax, World world, Class class1, Class class2,Class class3)
    {
        this.world = world;
        this.class1 = class1;
        this.class2 = class2;
    ...
    private void updateGraph()
    {
        ...
        List class3Objects = world.getObjects(class3);
        graph.update(step, class1Objects.size(), class2Objects.size(),class3Objects.size());
    ...
    private JFrame makeFrame(int width, int height, int startMax)
    {
        ...
        JPanel bottom = new JPanel();
            ...
            bottom.add(new JLabel("  " + class3.getName() + ":"));
            count3Label = new JLabel("");
            bottom.add(count3Label);
    ...
    class GraphPanel extends JComponent
    {
         ...
         */
        public void update(int step, int count1, int count2, int count3)
        {
            Graphics g = graphImage.getGraphics();
